...
export const IconCategoryHouse: React.FC<IPropsIcon> = ({ className }) => {
  return (
    <svg
      version="1.1"
    ...
    >
      <g>
        <g>
          <path
            d="M418.392,291.7l-192.4-215.8c-5.9-6.6-16.3-6.6-22.2,0l-192.4,215.8c-6.5,7.3-1.3,18.9,8.5,18.9h43.7v158.8
          ...
          />
          <path
            d="M481.692,48.9l-22.5,22.5c-52.8-52.8-138.7-52.8-191.4,0l-22.5-22.5C310.492-16.3,416.492-16.3,481.692,48.9z
