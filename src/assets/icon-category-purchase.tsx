...
export const IconCategoryPurchase: React.FC<IPropsIcon> = ({ className }) => {
  return (
    <svg
      version="1.1"
      x="0px"
      y="0px"
      viewBox="0 0 296.719 296.719"
      className={className}
      stroke="currentColor"
      fill="currentColor"
    >
      <path
        d="M225.605,96.931c-1.369-9.706-10.829-17.906-20.829-17.906v-21.29C204.776,25.899,179.043,0,147.277,0
