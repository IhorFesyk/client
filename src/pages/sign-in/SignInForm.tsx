...
interface IProps {
  initialValues: SingInFormValues
  loading: boolean
  // eslint-disable-next-line no-unused-vars
  onSubmit: (values: SingInFormValues) => void
}

const SignInForm: React.FC<IProps> = ({ initialValues, loading, onSubmit }) => {
  return (
    <Formik initialValues={initialValues} onSubmit={onSubmit}>
      {({ values, handleChange, handleSubmit }) => {
        return (
          ...
          >
            <p className="text-gray-800 text-center text-2xl">Sign In</p>
            ...
            <div className="flex justify-center">
              <p className="text-gray-400">
                ...
                <Link className="text-gray-700 underline" to="registration">
                  Sign Up
                </Link>
              </p>
            </div>
