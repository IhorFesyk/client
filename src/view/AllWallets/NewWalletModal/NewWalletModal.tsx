...
import { INewWalletModalProps } from "../types";
import { NewWalletModalForm } from "./NewWalletModalForm";

export const NewWalletModal: React.FC<INewWalletModalProps> = ({
  isOpen,
  onClose,
}) => {
          ...
          >
            <div className="inline-block bg-white text-left shadow-xl transform transition-all my-8 align-middle max-w-lg w-full">
              ...
              <div className="bg-white">
                <NewWalletModalForm onClose={onClose} />
              </div>
            </div>
          </Transition.Child>
        </div>
